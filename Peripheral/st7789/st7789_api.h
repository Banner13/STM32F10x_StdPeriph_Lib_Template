...
#define ColumnAddressOrder          RightToLeft
/* ************ config *********** */
...
#define Page_ColumnOrder            ReverseMode
/* ************ config *********** */
...
#define LineAddressOrder            LCDRefreshBottomToTop
/* ************ config *********** */
...
#define DisplayDataLatchDataOrder   LCDRefreshLeftToRight
/* ************ config *********** */
